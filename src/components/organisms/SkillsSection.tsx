...
const skillsData: Skill[] = [
  // Frontend
  { name: 'TypeScript', experience: '4 anos', category: 'frontend', description: 'JavaScript com tipagem estática' },
  { name: 'JavaScript', experience: '5 anos', category: 'frontend', description: 'Linguagem de programação web' },
  { name: 'Next.js', experience: '3 anos', category: 'frontend', description: 'Framework React para produção' },
  { name: 'React', experience: '3 anos', category: 'frontend', description: 'Biblioteca para interfaces de usuário' },
  { name: 'Angular', experience: '3 anos', category: 'frontend', description: 'Framework para aplicações web' },
  { name: 'RXJS', experience: '2 anos', category: 'frontend', description: 'Biblioteca para programação reativa' },
  { name: 'NgRx', experience: '2 anos', category: 'frontend', description: 'Biblioteca para gerenciamento de estado' },
  { name: 'Tailwind CSS', experience: '2 anos', category: 'frontend', description: 'Framework CSS utility-first' },
  { name: 'Framer Motion', experience: '1 anos', category: 'frontend', description: 'Biblioteca para animações' },
  { name: 'Shadcn UI', experience: '1 anos', category: 'frontend', description: 'Biblioteca de componentes' },
  { name: 'Redux', experience: '1 anos', category: 'frontend', description: 'Biblioteca para gerenciamento de estado' },
  { name: 'Zod', experience: '1 anos', category: 'frontend', description: 'Biblioteca para validação de dados' },
  { name: 'HTML5', experience: '5 anos', category: 'frontend', description: 'Linguagem de marcação web' },
  { name: 'CSS3', experience: '5 anos', category: 'frontend', description: 'Folhas de estilo em cascata' },

  // Backend
  { name: 'Node.js', experience: '2 anos', category: 'backend', description: 'Runtime JavaScript no servidor' },
  { name: 'Express', experience: '2 anos', category: 'backend', description: 'Framework web para Node.js' },
  { name: 'Python', experience: '1 anos', category: 'backend', description: 'Linguagem de programação versátil' },
  ...
  // Database
  { name: 'MongoDB', experience: '2 anos', category: 'database', description: 'Banco de dados NoSQL' },
  { name: 'PostgreSQL', experience: '2 anos', category: 'database', description: 'Banco de dados relacional avançado' },
  { name: 'MySQL', experience: '1 anos', category: 'database', description: 'Sistema de gerenciamento de banco de dados' },
  ...
  { name: 'Azure', experience: '1 ano', category: 'tools', description: 'Azure Web Services' },

  // AI & Machine Learning
  { name: 'OpenAI API', experience: '1 anos', category: 'ai', description: 'Integração com modelos de linguagem' },
  ...
  { name: 'Python ML', experience: '1 anos', category: 'ai', description: 'Machine Learning com Python' },
